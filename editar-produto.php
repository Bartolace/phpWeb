<?php
    ...
    $produto = $produtoRepositorio->findById($_GET['id']);

    if (isset($_POST['editar'])){
        $produtoEditando = new Produto($_POST['id'], $_POST['tipo'], $_POST['nome'],
        ...
        $produtoRepositorio->update($produtoEditando);
        header("Location: admin.php");
    }else{
        $produtoEditando = $produtoRepositorio->findById($_GET['id']);
    }
  ...
  <section class="container-form">
    <form method="post" enctype="multipart/form-data">
      ...
      <input type="file" name="imagem" accept="image/*" id="imagem"
             value="<?= $produto->getImagem() ?>" placeholder="Envie uma imagem">
