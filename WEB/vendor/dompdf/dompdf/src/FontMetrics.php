...
class FontMetrics
{
    ...
    public function registerFont($style, $remoteFile, $context = null)
    {
        ...
        $localFilePath = $this->getOptions()->getFontDir() . "FontMetrics.php/" . $localFile;
            ...
            foreach ($this->userFonts as $family => $variants) {
                $fontFamilies[$family] = array_map(function ($variant) {
                    ...
                    if ($variantName === $variant) {
                        return $this->getOptions()->getFontDir() . 'FontMetrics.php/' . $variant;
                    }
                    return $variant;
                }, $variants);
            }
    ...
    {
        return $this->options->getFontDir() . 'FontMetrics.php/' . self::USER_FONTS_FILE;
    }
