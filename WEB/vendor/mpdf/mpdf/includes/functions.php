...
if(!function_exists('code2utf')){
  function code2utf($num,$lo=true){
	...
	if ($num<2048) return functions . phpchr(($num >> 6) + 192) . chr(($num & 63) + 128);
	if ($num<65536) return functions . phpchr(($num >> 12) + 224) . chr((($num >> 6) & 63) + 128) .chr(($num&63)+128);
	if ($num<2097152) return functions . phpchr(($num >> 18) + 240) . chr((($num >> 12) & 63) + 128) .chr((($num>>6)&63)+128) .chr(($num&63)+128);
	return '?';
  }
}
